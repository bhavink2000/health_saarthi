class PackageItemDetailsModel {
  dynamic status;
  Data? data;
  CartData? cartData;

  PackageItemDetailsModel({this.status, this.data, this.cartData});

  PackageItemDetailsModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    testPackages = json['test_packages'] != null
        ? new TestPackages.fromJson(json['test_packages'])
        : null;
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.testPackages != null) {
      data['test_packages'] = this.testPackages!.toJson();
    }
    return data;
  }
}
...
class TestPackages {
  ...
  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = new Map<String, dynamic>();
    data['id'] = this.id;
    data['sufalam_package_id'] = this.sufalamPackageId;
    data['sufalam_service_id'] = this.sufalamServiceId;
    ...
    data['updated_at'] = this.updatedAt;
    data['deleted_at'] = this.deletedAt;
    data['enc_test_package_id'] = this.encTestPackageId;
    data['create_at'] = this.createAt;
    return data;
  }
}
