...
import 'package:health_saarthi/Heath%20Saarthi/App%20Helper/Frontend%20Helper/size_config.dart';
...
class _HomeBodyCheckupsState extends State<HomeBodyCheckups> {
  ...
  void popularPack() async {
    ...
    try {
      Map<String, dynamic> popularP = await HomeMenuRepo().popularPackageData(0,'');
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          InkWell(
                            onTap: (){
                              CartFuture().addToCartTest(popularPackage[index]['test_management_id']).then((value) {});
                              setState(() {
